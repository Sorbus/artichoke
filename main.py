...
if __name__ == '__main__':
  ...
  parser.add_argument('-s', '--self', help='gather information about yourself', action='store_true')
  ...
  parser.add_argument('-C', '--concise', help='only print results', action='store_true')
  parser.add_argument('-w', '--width', help='width of bar chart (default: width of terminal or 80)',type=check_positive,
